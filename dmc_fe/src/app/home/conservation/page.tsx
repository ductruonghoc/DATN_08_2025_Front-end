      ...
      <div className="w-full max-w-2xl">
        <div className="relative rounded-xl shadow-md bg-white">
          <input
            ...
            className="w-full py-4 px-12 border border-gray-200 rounded-xl text-base focus:outline-none"
            value={inputValue}
          ...
          <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
            ...
            <button
              className="p-1.5 bg-black text-white rounded-full flex items-center justify-center"
