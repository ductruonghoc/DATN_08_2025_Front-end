...
export default function PDFDetail({ pdfDetail }: PDFDetailProps) {
  ...
  return (
    <div className="w-72 bg-white dark:bg-gray-800 rounded-[10px] border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm flex flex-col">
      ...
      <div className="p-4 flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600">
        {/* Filename section */}
        <div className="mb-4">
          ...
          <p className="text-xs font-medium text-[#2e3139] dark:text-white pl-6 break-words">{pdfDetail.filename}</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="bg-[#f9f9f9] dark:bg-gray-700 p-3 rounded-[10px]">
            ...
            <p className="text-sm font-semibold dark:text-white">{pdfDetail.pages}</p>
          </div>
          ...
          <div className="bg-[#f9f9f9] dark:bg-gray-700 p-3 rounded-[10px] flex items-start">
            ...
            <div>
              ...
              <p className="text-xs font-medium dark:text-white">{pdfDetail.uploadAt}</p>
            </div>
          </div>
          ...
          <div className="bg-[#f9f9f9] dark:bg-gray-700 p-3 rounded-[10px] flex items-start">
            ...
            <div>
              ...
              <p className="text-xs font-medium dark:text-white">{pdfDetail.lastAccess}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#f1f6ff] dark:bg-gray-700 p-4 rounded-[10px] mb-4">
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div className="bg-white dark:bg-gray-800 p-2 rounded-[10px]">
              ...
              <p className="text-xs font-medium dark:text-white">{pdfDetail.device.brand}</p>
            </div>

            <div className="bg-white dark:bg-gray-800 p-2 rounded-[10px]">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Type</p>
              <p className="text-xs font-medium dark:text-white">{pdfDetail.device.type}</p>
            </div>

            <div className="bg-white dark:bg-gray-800 p-2 rounded-[10px]">
              <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Model</p>
              <p className="text-xs font-medium dark:text-white">{pdfDetail.device.model}</p>
            </div>
          </div>
        </div>
      </div>
