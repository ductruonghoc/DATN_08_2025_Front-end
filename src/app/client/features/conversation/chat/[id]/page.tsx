  ...
  const handleSendMessage = async () => {
    ...
    if (id === "new") {
      try {
        ...
        router.replace(`/client/features/conversation/chat/${json.data.conversation_id}?firstMsg=${encodeURIComponent(userMessage.content)}&title=${encodeURIComponent(json.data.title)}`)
        return
      } catch (err: any) {
